    ...
    <footer className="border-t border-primary/20 bg-card/50 backdrop-blur-sm relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2 animate-fade-in-up opacity-0" style={{ animationFillMode: 'forwards' }}>
            <Link href="/" className="flex items-center gap-3 mb-4 group">
              <div className="relative">
                ...
                <Image
                  ...
                  width={100}
                  height={35}
                  className="relative h-8 w-auto drop-shadow-[0_0_8px_rgba(0,255,255,0.4)] group-hover:drop-shadow-[0_0_16px_rgba(0,255,255,0.6)] transition-all duration-300"
                />
              </div>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-primary/20 flex flex-col md:flex-row items-center justify-between gap-4 animate-fade-in-up opacity-0" style={{ animationDelay: '450ms', animationFillMode: 'forwards' }}>
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} TechSpaw. Wszelkie prawa zastrzezone.
          </p>
          <div className="flex items-center gap-6">
            <Link href="/blog" className="text-sm text-muted-foreground hover:text-primary transition-all duration-300">
              Blog
            </Link>
            <Link href="/" className="text-sm text-muted-foreground hover:text-primary transition-all duration-300">
              Strona glowna
            </Link>
          </div>
        </div>
