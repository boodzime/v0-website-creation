      ...
      <main className="flex-1">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-24 md:py-32">
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 rounded-full border border-primary/50 bg-primary/10 px-4 py-2 mb-6 shadow-[0_0_20px_rgba(0,255,255,0.3)]">
                ...
                <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground mb-6">
                  <span className="bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(0,255,255,0.5)]">
                    TECHSPAW
                  </span>
                  <br />
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    Przegladaj artykuly
                    <svg className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M5 12h14M12 5l7 7-7 7" />
                    </svg>
                  </Link>
                  <Link
                    href="/blog?kategoria=Techniki"
                    className="inline-flex h-12 items-center justify-center rounded-lg border border-primary/50 bg-card/50 px-8 text-base font-medium text-foreground transition-all hover:border-primary hover:shadow-[0_0_20px_rgba(0,255,255,0.3)] hover:bg-primary/10"
                  >
                    Techniki spawania
                  </Link>
                </div>
              ...
              <div className="hidden lg:block flex-shrink-0">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-primary/30 to-accent/30 blur-3xl rounded-full scale-150" />
                  <Image
                    src="/logo.png"
                    alt="TechSpaw Logo"
                    width={300}
          ...
          <div className="absolute -right-20 top-1/2 -translate-y-1/2 hidden xl:block opacity-50">
            <div className="relative h-96 w-96">
              ...
              <svg
                ...
                fill="none"
              >
                <circle cx="100" cy="100" r="80" stroke="url(#gradient1)" strokeWidth="1" strokeDasharray="8 8" className="animate-spin" style={{ animationDuration: '30s' }} />
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {[
                ...
                <div key={index} className="text-center group">
                  <div className="font-heading text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-2 group-hover:drop-shadow-[0_0_20px_rgba(0,255,255,0.5)] transition-all">
                    {stat.value}
                  </div>
        ...
        <section className="py-16 md:py-24 relative">
          ...
          <div className="relative mx-auto max-w-6xl px-4">
            <div className="flex items-end justify-between mb-10">
              ...
              <Link
                href="/blog"
                className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-primary hover:gap-3 transition-all hover:text-accent"
              >
                Zobacz wszystkie
        ...
        <section className="py-16 md:py-24 bg-card/30 border-y border-border relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4">
            ...
            <div className="mt-10 text-center md:hidden">
              <Link
                href="/blog"
                className="inline-flex h-12 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-accent px-8 text-base font-semibold text-primary-foreground transition-all hover:shadow-[0_0_30px_rgba(0,255,255,0.5)]"
              >
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-4">
            <div className="relative overflow-hidden rounded-2xl border border-primary/30 p-8 md:p-12 bg-gradient-to-br from-card via-card to-primary/5">
