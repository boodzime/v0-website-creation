      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-primary/50 rounded-full animate-float" style={{ animationDuration: '6s' }} />
            <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-accent/30 rounded-full animate-float" style={{ animationDuration: '7s', animationDelay: '1s' }} />
            <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-primary/40 rounded-full animate-float" style={{ animationDuration: '5s', animationDelay: '2s' }} />
            <div className="absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-accent/50 rounded-full animate-float" style={{ animationDuration: '8s', animationDelay: '0.5s' }} />
          </div>
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-24 md:py-32">
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
              <div className="flex-1">
                {/* Animated badge */}
                <div className="animate-fade-in-up opacity-0 inline-flex items-center gap-2 rounded-full border border-primary/50 bg-primary/10 px-4 py-2 mb-6 shadow-[0_0_20px_rgba(0,255,255,0.2)]" style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
                  <span className="relative flex h-2 w-2">
                    <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-primary opacity-75" style={{ animationDuration: '2s' }} />
                    <span className="relative inline-flex h-2 w-2 rounded-full bg-primary shadow-[0_0_8px_rgba(0,255,255,0.8)]" />
                  </span>
                ...
                <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground mb-6">
                  <span className="animate-fade-in-up inline-block opacity-0" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
                    <span className="text-gradient-animate">TECH</span>
                  </span>
                  <span className="animate-fade-in-up inline-block opacity-0" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
                    <span className="text-gradient-animate">SPAW</span>
                  </span>
                  <br />
                  <span className="animate-slide-in-left inline-block opacity-0 text-foreground" style={{ animationDelay: '450ms', animationFillMode: 'forwards' }}>Blog</span>
                  <span className="animate-slide-in-right inline-block opacity-0" style={{ animationDelay: '550ms', animationFillMode: 'forwards' }}>
                    <span className="bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent"> Spawalniczy</span>
                  </span>
                </h1>
                
                {/* Animated underline */}
                <div className="h-1 w-0 bg-gradient-to-r from-primary to-accent rounded-full mb-6 animate-[expand_0.8s_cubic-bezier(0.16,1,0.3,1)_0.7s_forwards]" />
                
                <p className="animate-fade-in-up text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl opacity-0" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
                  Techniki <span className="text-primary font-semibold">MIG</span>, <span className="text-accent font-semibold">TIG</span>, <span className="text-primary font-semibold">MMA</span> i wiele wiecej. Praktyczna wiedza, porady ekspertow i recenzje sprzetu dla spawaczy na kazdym poziomie.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/blog"
                    className="group animate-scale-in opacity-0 inline-flex h-12 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-accent px-8 text-base font-semibold text-primary-foreground transition-all duration-300 hover:shadow-[0_0_24px_rgba(0,255,255,0.4)] hover:scale-[1.02] hover-glow"
                    style={{ animationDelay: '900ms', animationFillMode: 'forwards' }}
                  >
                    <span className="relative z-10 flex items-center">
                      Przegladaj artykuly
                      <svg className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <Link
                    ...
                    className="animate-scale-in opacity-0 inline-flex h-12 items-center justify-center rounded-lg border border-primary/50 bg-card/50 px-8 text-base font-medium text-foreground transition-all duration-300 hover:border-primary hover:shadow-[0_0_16px_rgba(0,255,255,0.25)] hover:bg-primary/10"
              ...
              <div className="hidden lg:block flex-shrink-0">
                <div className="relative animate-scale-in opacity-0" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
                  <div className="animate-float" style={{ animationDuration: '6s' }}>
                    <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-accent/20 blur-3xl rounded-full scale-150" />
                    <Image
                      src="/logo.png"
                      alt="TechSpaw Logo"
                      width={300}
                      height={300}
                      className="relative drop-shadow-[0_0_30px_rgba(0,255,255,0.4)] hover:drop-shadow-[0_0_50px_rgba(0,255,255,0.6)] transition-all duration-500 hover:scale-105"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-12">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {[
                ...
                <div 
                  key={index} 
                  className="text-center group animate-fade-in-up opacity-0 hover-lift cursor-default p-4 rounded-xl transition-all duration-300 hover:bg-card/80"
                ...
                >
                  <div className="font-heading text-3xl md:text-5xl font-bold mb-2">
                    <span className="text-gradient-animate transition-all">
                      {stat.value}
                    </span>
                  </div>
        ...
        <section className="py-16 md:py-24 bg-card/30 border-y border-border relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {recentPosts.map((post, index) => (
                <div 
                  ...
                  style={{ animationDelay: `${index * 80 + 500}ms`, animationFillMode: 'forwards' }}
                >
                  <BlogCard post={post} />
                </div>
              ))}
            ...
            <div className="mt-10 text-center md:hidden">
              <Link
                href="/blog"
                className="animate-fade-in-up opacity-0 inline-flex h-12 items-center justify-center rounded-lg bg-gradient-to-r from-primary to-accent px-8 text-base font-semibold text-primary-foreground transition-all duration-300 hover:shadow-[0_0_24px_rgba(0,255,255,0.4)] hover-glow"
                style={{ animationDelay: '900ms', animationFillMode: 'forwards' }}
              >
        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-accent/40 rounded-br-2xl" />
