  ...
  const renderContent = (content: string) => {
    ...
    lines.forEach((line, index) => {
      ...
      if (trimmedLine.startsWith('## ')) {
        elements.push(
          <h2 key={index} className="font-heading text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mt-10 mb-4">
            {trimmedLine.replace('## ', '')}
          </h2>
        )
      ...
      // Lists
        ...
        elements.push(
          <li key={index} className="ml-6 mb-2 text-muted-foreground list-disc marker:text-primary">
            {boldMatch ? (
              <>
      ...
      <main className="flex-1">
          ...
          <div className="relative mx-auto max-w-4xl px-4 py-12 md:py-16">
            ...
            <div className="flex items-center gap-3 mb-6">
              <Link 
                ...
                className="inline-flex items-center rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 px-3 py-1 text-sm font-medium text-primary hover:shadow-[0_0_15px_rgba(0,255,255,0.3)] transition-all"
              >
                {post.category}
              </Link>
        ...
        <section className="border-b border-primary/20">
          <div className="mx-auto max-w-5xl px-4 py-8">
            <div className="relative aspect-video overflow-hidden rounded-2xl bg-muted border border-primary/20 shadow-[0_0_40px_rgba(0,255,255,0.1)]">
              <Image
                src={post.image}
                alt={post.title}
                fill
          ...
          <div className="relative mx-auto max-w-3xl px-4">
            ...
            <div className="mt-12 pt-8 border-t border-primary/20">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-heading font-semibold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-1">Podziel sie artykulem</h4>
                  <p className="text-sm text-muted-foreground">Jesli artykul byl pomocny, udostepnij go innym!</p>
                </div>
                <div className="flex items-center gap-3">
                  <button className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-primary/30 bg-card text-muted-foreground hover:text-primary hover:border-primary hover:shadow-[0_0_15px_rgba(0,255,255,0.3)] transition-all">
